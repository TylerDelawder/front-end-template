...
1. .icon
.. This changes the size of the icon at the top left of the page.
2. .navbar-text
.. This changes the size, color, and alignment of the navigation text.
3. .nav-link
.. This changes the color of the navigation links.
4. a:hover
.. This changes the color of the links when hovering over them.
5. .footer
